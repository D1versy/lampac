...
window.qdl_fork_version = '2.3';   // 2.0: умная выдача раздач (⭐ скоринг, серии/дата/🔔) + охота за сериями по всем раздачам (/qdl/episodes, серии-доноры «врем.», tl-таймлайн) + SWITCH-переключение; 2.1: фиксы ревью — аудио доноров по своему hash, SWITCH-тост без «скачана»; 2.2: пункт меню «D1VERSY LIVE» — записи видеорегистратора (день → камеры с записями → плеер, прокси /qdl/live/*); 2.3: весь день ОДНОЙ записью с одним таймлайном (склеенный HLS /qdl/live/day), фрагменты — запасной путь
