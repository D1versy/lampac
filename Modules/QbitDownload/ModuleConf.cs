...
public class ModuleConf : ModuleBaseConf
{
    ...
    // Охотничья выборка: все раздачи СЕЗОНА по episodes jsonb (337–609 строк на сезон у наших
    // сериалов, 20–270 мс). Потолок страховочный — от аномального тайтла со сквозной нумерацией.
    public int bitmagnetHuntLimit { get; set; } = 1000;
