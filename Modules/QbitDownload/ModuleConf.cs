...
public class ModuleConf : ModuleBaseConf
{
    ...
    // Краулер обновляет сиды только когда работает. Если данные подтухли, живые раздачи трекеров
    // не должны проигрывать ⭐ архивным: старше N дней → сиды в скоринг не отдаём (0 = не резать).
